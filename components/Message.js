const ErrorMessage = ({ children }) => (
	<div className="flex items-center text-red-500">
		...
		<p className="ml-2 text-sm font-bold text-red-800 dark:text-red-400">{children}</p>
	</div>
);
...
const SuccessMessage = ({ children }) => (
	<div className="flex items-center text-green-400">
		...
		<p className="mr-2 text-sm font-bold text-green-700 dark:text-green-400">{children}</p>
	</div>
);
